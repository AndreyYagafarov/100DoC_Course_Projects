# the purpose of this script is to scrap the most recent data for the day 98 assignment
...
for page_no in range(1, last_page + 1):  # loop through every page.
    ...
    for i in range(len(missions_in_page)):  # loop through all missions in one page.
        ...
        record = {
            ...
            "Date": location_datetime_split[0],
            "Detail": details_soup.getText(),
            "Rocket_Status": mission_data_soup.getText(strip=True).split(': ')[1],
